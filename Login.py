...
user_name_label = Label(login, text='User Name:', font=(
    'Calibri', 14), background='#EDE6E3')
...
pass_label = Label(login, text='Password:', font=(
    'Calibri', 14), background='#EDE6E3')
...
result = Label(login, font=('Candra', 8),
               background='#EDE6E3', foreground='red')
result.place(x=150, y=310)

submit = Button(login, text='Login', relief='flat', command=check_admin)
submit.config(background='#00BD9D', font=(
    'Britannic Bold', 18), foreground='white')
submit.place(x=150, y=380, width=200, height=40)

register = Label(login, text='Register', cursor='hand2',
                 fg='#3F3244', font=('Arial', 10), background='#EDE6E3')
